...
namespace GoalFinder.MySqlRelationalDb.Migrations
{
    ...
    [Migration("20240420082924_M1_Init_Db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoalFinder.Data.Entities.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Districts", null, t =>
                        {
                            t.HasComment("Contain district records.");
                        });
                });
            ...
            modelBuilder.Entity("GoalFinder.Data.Entities.Province", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Provinces", null, t =>
                        {
                            t.HasComment("Contain province records.");
                        });
                });
            ...
            modelBuilder.Entity("GoalFinder.Data.Entities.Ward", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("Wards", null, t =>
                        {
                            t.HasComment("Contain ward records.");
                        });
                });
            ...
            modelBuilder.Entity("GoalFinder.Data.Entities.District", b =>
                {
                    b.HasOne("GoalFinder.Data.Entities.Province", "Province")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("GoalFinder.Data.Entities.FootballMatch", b =>
                {
                    ...
                    b.HasOne("GoalFinder.Data.Entities.Ward", "Ward")
                        .WithMany()
            ...
            modelBuilder.Entity("GoalFinder.Data.Entities.Ward", b =>
                {
                    b.HasOne("GoalFinder.Data.Entities.District", "District")
                        .WithMany("Wards")
